...
public class FastScroller {
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        try {
            ...
            int popupTextSize = typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollPopupTextSize, FastScrollUtils.toScreenPixels(resources, 56));
            int popupBackgroundSize = typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollPopupBackgroundSize, FastScrollUtils.toPixels(resources, 88));
            ...
            mPopup.setTypeface(Typeface.create("sans-serif-light", Typeface.NORMAL));
